...
import org.openapitools.client.model.ContentCreateRequest;
...
public class ArtifactsApi {
    ...
    private okhttp3.Call createArtifactValidateBeforeCall(String groupId, Object body, ArtifactType xRegistryArtifactType, String xRegistryArtifactId, String xRegistryVersion, IfExists ifExists, Boolean canonical, String xRegistryDescription, String xRegistryDescriptionEncoded, String xRegistryName, String xRegistryNameEncoded, String xRegistryContentHash, String xRegistryHashAlgorithm, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createArtifactCall(groupId, body, xRegistryArtifactType, xRegistryArtifactId, xRegistryVersion, ifExists, canonical, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryName, xRegistryNameEncoded, xRegistryContentHash, xRegistryHashAlgorithm, _callback);
        return localVarCall;
     ...
     */
    public ApiResponse<ArtifactMetaData> createArtifactWithHttpInfo(String groupId, Object body, ArtifactType xRegistryArtifactType, String xRegistryArtifactId, String xRegistryVersion, IfExists ifExists, Boolean canonical, String xRegistryDescription, String xRegistryDescriptionEncoded, String xRegistryName, String xRegistryNameEncoded, String xRegistryContentHash, String xRegistryHashAlgorithm) throws ApiException {
    ...
    private okhttp3.Call deleteArtifactValidateBeforeCall(String groupId, String artifactId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteArtifactCall(groupId, artifactId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteArtifactsInGroupValidateBeforeCall(String groupId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteArtifactsInGroupCall(groupId, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getContentByGlobalIdCall(Long globalId, Boolean dereference, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/ids/globalIds/{globalId}"
            .replaceAll("\\{" + "globalId" + "\\}", localVarApiClient.escapeString(globalId.toString()));
    ...
    private okhttp3.Call getContentByGlobalIdValidateBeforeCall(Long globalId, Boolean dereference, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getContentByGlobalIdCall(globalId, dereference, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getContentByHashCall(String contentHash, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/ids/contentHashes/{contentHash}/"
            .replaceAll("\\{" + "contentHash" + "\\}", localVarApiClient.escapeString(contentHash.toString()));
    ...
    private okhttp3.Call getContentByHashValidateBeforeCall(String contentHash, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getContentByHashCall(contentHash, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getContentByIdValidateBeforeCall(Long contentId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getContentByIdCall(contentId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getLatestArtifactValidateBeforeCall(String groupId, String artifactId, Boolean dereference, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getLatestArtifactCall(groupId, artifactId, dereference, _callback);
        return localVarCall;
    ...
    private okhttp3.Call listArtifactsInGroupValidateBeforeCall(String groupId, Integer limit, Integer offset, SortOrder order, SortBy orderby, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listArtifactsInGroupCall(groupId, limit, offset, order, orderby, _callback);
        return localVarCall;
    ...
    private okhttp3.Call referencesByContentHashValidateBeforeCall(String contentHash, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = referencesByContentHashCall(contentHash, _callback);
        return localVarCall;
    ...
    private okhttp3.Call referencesByContentIdValidateBeforeCall(Long contentId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = referencesByContentIdCall(contentId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call referencesByGlobalIdValidateBeforeCall(Long globalId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = referencesByGlobalIdCall(globalId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call searchArtifactsValidateBeforeCall(String name, Integer offset, Integer limit, SortOrder order, SortBy orderby, List<String> labels, List<String> properties, String description, String group, Long globalId, Long contentId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchArtifactsCall(name, offset, limit, order, orderby, labels, properties, description, group, globalId, contentId, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call searchArtifactsByContentCall(File body, Boolean canonical, ArtifactType artifactType, Integer offset, Integer limit, String order, String orderby, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchArtifactsByContentValidateBeforeCall(File body, Boolean canonical, ArtifactType artifactType, Integer offset, Integer limit, String order, String orderby, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchArtifactsByContentCall(body, canonical, artifactType, offset, limit, order, orderby, _callback);
        return localVarCall;
     ...
     */
    public ApiResponse<ArtifactSearchResults> searchArtifactsByContentWithHttpInfo(File body, Boolean canonical, ArtifactType artifactType, Integer offset, Integer limit, String order, String orderby) throws ApiException {
     ...
     */
    public okhttp3.Call searchArtifactsByContentAsync(File body, Boolean canonical, ArtifactType artifactType, Integer offset, Integer limit, String order, String orderby, final ApiCallback<ArtifactSearchResults> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateArtifactCall(String groupId, String artifactId, Object body, String xRegistryVersion, String xRegistryName, String xRegistryNameEncoded, String xRegistryDescription, String xRegistryDescriptionEncoded, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateArtifactValidateBeforeCall(String groupId, String artifactId, Object body, String xRegistryVersion, String xRegistryName, String xRegistryNameEncoded, String xRegistryDescription, String xRegistryDescriptionEncoded, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateArtifactCall(groupId, artifactId, body, xRegistryVersion, xRegistryName, xRegistryNameEncoded, xRegistryDescription, xRegistryDescriptionEncoded, _callback);
        return localVarCall;
     ...
     */
    public ApiResponse<ArtifactMetaData> updateArtifactWithHttpInfo(String groupId, String artifactId, Object body, String xRegistryVersion, String xRegistryName, String xRegistryNameEncoded, String xRegistryDescription, String xRegistryDescriptionEncoded) throws ApiException {
     ...
     */
    public okhttp3.Call updateArtifactAsync(String groupId, String artifactId, Object body, String xRegistryVersion, String xRegistryName, String xRegistryNameEncoded, String xRegistryDescription, String xRegistryDescriptionEncoded, final ApiCallback<ArtifactMetaData> _callback) throws ApiException {
    ...
    private okhttp3.Call updateArtifactStateValidateBeforeCall(String groupId, String artifactId, UpdateState updateState, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateArtifactStateCall(groupId, artifactId, updateState, _callback);
        return localVarCall;
