...
public class ArtifactRulesApi {
    ...
    private okhttp3.Call createArtifactRuleValidateBeforeCall(String groupId, String artifactId, Rule rule, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createArtifactRuleCall(groupId, artifactId, rule, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteArtifactRuleValidateBeforeCall(String groupId, String artifactId, String rule, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteArtifactRuleCall(groupId, artifactId, rule, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteArtifactRulesValidateBeforeCall(String groupId, String artifactId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteArtifactRulesCall(groupId, artifactId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getArtifactRuleConfigValidateBeforeCall(String groupId, String artifactId, String rule, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getArtifactRuleConfigCall(groupId, artifactId, rule, _callback);
        return localVarCall;
    ...
    private okhttp3.Call listArtifactRulesValidateBeforeCall(String groupId, String artifactId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listArtifactRulesCall(groupId, artifactId, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call testUpdateArtifactCall(String groupId, String artifactId, Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call testUpdateArtifactValidateBeforeCall(String groupId, String artifactId, Object body, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = testUpdateArtifactCall(groupId, artifactId, body, _callback);
        return localVarCall;
     ...
     */
    public ApiResponse<Void> testUpdateArtifactWithHttpInfo(String groupId, String artifactId, Object body) throws ApiException {
     ...
     */
    public okhttp3.Call testUpdateArtifactAsync(String groupId, String artifactId, Object body, final ApiCallback<Void> _callback) throws ApiException {
    ...
    private okhttp3.Call updateArtifactRuleConfigValidateBeforeCall(String groupId, String artifactId, String rule, Rule rule2, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateArtifactRuleConfigCall(groupId, artifactId, rule, rule2, _callback);
        return localVarCall;
