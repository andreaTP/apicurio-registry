...
// @ts-ignore
import { LimitsRequestBuilderRequestsMetadata, type LimitsRequestBuilder } from './limits/index.js';
// @ts-ignore
import { type UiConfigRequestBuilder, UiConfigRequestBuilderRequestsMetadata } from './uiConfig/index.js';
// @ts-ignore
...
export const SystemRequestBuilderNavigationMetadata: Record<Exclude<keyof SystemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    limits: {
        requestsMetadata: LimitsRequestBuilderRequestsMetadata,
    },
    uiConfig: {
        requestsMetadata: UiConfigRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
