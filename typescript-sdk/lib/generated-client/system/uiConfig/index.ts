...
// @ts-ignore
import { createProblemDetailsFromDiscriminatorValue, createUserInterfaceConfigFromDiscriminatorValue, type ProblemDetails, type UserInterfaceConfig } from '../../models/index.js';
// @ts-ignore
 ...
 */
export const UiConfigRequestBuilderUriTemplate = "{+baseurl}/system/uiConfig";
/**
 * Metadata for all the requests in the request builder.
 */
export const UiConfigRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: UiConfigRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        errorMappings: {
            500: createProblemDetailsFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
        adapterMethodName: "send",
        responseBodyFactory:  createUserInterfaceConfigFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
