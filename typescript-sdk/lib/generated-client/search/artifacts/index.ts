...
// @ts-ignore
import { ArtifactSortBy, createArtifactSearchResultsFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, SortOrder, type ArtifactSearchResults, type ProblemDetails } from '../../models/index.js';
// @ts-ignore
 ...
 */
export const ArtifactsRequestBuilderUriTemplate = "{+baseurl}/search/artifacts{?artifactId*,artifactType*,canonical*,contentId*,description*,globalId*,groupId*,labels*,limit*,name*,offset*,order*,orderby*}";
/**
