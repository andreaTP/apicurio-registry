...
// @ts-ignore
import { createGroupSearchResultsFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, GroupSortBy, SortOrder, type GroupSearchResults, type ProblemDetails } from '../../models/index.js';
// @ts-ignore
 ...
 */
export const GroupsRequestBuilderUriTemplate = "{+baseurl}/search/groups{?description*,groupId*,labels*,limit*,offset*,order*,orderby*}";
/**
