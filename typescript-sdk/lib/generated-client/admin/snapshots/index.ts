...
// @ts-ignore
import { createProblemDetailsFromDiscriminatorValue, createSnapshotMetaDataFromDiscriminatorValue, type ProblemDetails, type SnapshotMetaData } from '../../models/index.js';
// @ts-ignore
 ...
 */
export const SnapshotsRequestBuilderUriTemplate = "{+baseurl}/admin/snapshots";
/**
...
export const SnapshotsRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createSnapshotMetaDataFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
