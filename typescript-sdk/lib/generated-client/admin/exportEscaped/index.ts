...
// @ts-ignore
import { createDownloadRefFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, type DownloadRef, type ProblemDetails } from '../../models/index.js';
// @ts-ignore
 ...
 */
export const ExportRequestBuilderUriTemplate = "{+baseurl}/admin/export{?forBrowser*}";
/**
...
export const ExportRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createDownloadRefFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
