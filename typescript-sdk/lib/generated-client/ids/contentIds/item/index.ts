 ...
 */
export const WithContentItemRequestBuilderUriTemplate = "{+baseurl}/ids/contentIds/{contentId}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const WithContentItemRequestBuilderNavigationMetadata: Record<Exclude<keyof WithContentItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    references: {
 ...
 */
export const WithContentItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: WithContentItemRequestBuilderUriTemplate,
