...
// @ts-ignore
import { createGroupMetaDataFromDiscriminatorValue, createGroupSearchResultsFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, GroupSortBy, serializeCreateGroup, serializeGroupMetaData, SortOrder, type CreateGroup, type GroupMetaData, type GroupSearchResults, type ProblemDetails } from '../models/index.js';
// @ts-ignore
 ...
 */
export const GroupsRequestBuilderUriTemplate = "{+baseurl}/groups{?limit*,offset*,order*,orderby*}";
/**
...
export const GroupsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createGroupSearchResultsFromDiscriminatorValue,
    },
    post: {
        uriTemplate: GroupsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        ...
        requestBodySerializer: serializeCreateGroup,
