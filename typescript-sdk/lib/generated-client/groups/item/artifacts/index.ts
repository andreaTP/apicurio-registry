...
// @ts-ignore
import { ArtifactSortBy, createArtifactSearchResultsFromDiscriminatorValue, createCreateArtifactResponseFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, createRuleViolationProblemDetailsFromDiscriminatorValue, IfArtifactExists, serializeCreateArtifact, serializeCreateArtifactResponse, SortOrder, type ArtifactSearchResults, type CreateArtifact, type CreateArtifactResponse, type ProblemDetails, type RuleViolationProblemDetails } from '../../../models/index.js';
// @ts-ignore
import { type WithArtifactItemRequestBuilder, WithArtifactItemRequestBuilderNavigationMetadata, WithArtifactItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
 ...
 */
export const ArtifactsRequestBuilderUriTemplate = "{+baseurl}/groups/{groupId}/artifacts{?canonical*,dryRun*,ifExists*,limit*,offset*,order*,orderby*}";
/**
...
export const ArtifactsRequestBuilderNavigationMetadata: Record<Exclude<keyof ArtifactsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byArtifactId: {
        ...
        navigationMetadata: WithArtifactItemRequestBuilderNavigationMetadata,
...
export const ArtifactsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        ...
        responseBodyFactory:  createArtifactSearchResultsFromDiscriminatorValue,
    },
    post: {
        uriTemplate: ArtifactsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        ...
        adapterMethodName: "send",
        responseBodyFactory:  createCreateArtifactResponseFromDiscriminatorValue,
        requestBodyContentType: "application/json",
        requestBodySerializer: serializeCreateArtifact,
