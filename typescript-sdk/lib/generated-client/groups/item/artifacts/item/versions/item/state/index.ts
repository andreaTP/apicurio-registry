...
// @ts-ignore
import { createProblemDetailsFromDiscriminatorValue, createWrappedVersionStateFromDiscriminatorValue, serializeWrappedVersionState, type ProblemDetails, type WrappedVersionState } from '../../../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const StateRequestBuilderUriTemplate = "{+baseurl}/groups/{groupId}/artifacts/{artifactId}/versions/{versionExpression}/state{?dryRun*}";
/**
...
export const StateRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createWrappedVersionStateFromDiscriminatorValue,
    },
    put: {
        uriTemplate: StateRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        ...
        requestBodySerializer: serializeWrappedVersionState,
