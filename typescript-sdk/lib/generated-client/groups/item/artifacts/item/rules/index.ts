...
// @ts-ignore
import { createProblemDetailsFromDiscriminatorValue, RuleType, RuleTypeObject, serializeCreateRule, type CreateRule, type ProblemDetails } from '../../../../../models/index.js';
// @ts-ignore
import { type WithRuleTypeItemRequestBuilder, WithRuleTypeItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
 ...
 */
export const RulesRequestBuilderUriTemplate = "{+baseurl}/groups/{groupId}/artifacts/{artifactId}/rules";
/**
...
export const RulesRequestBuilderNavigationMetadata: Record<Exclude<keyof RulesRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byRuleType: {
        requestsMetadata: WithRuleTypeItemRequestBuilderRequestsMetadata,
...
export const RulesRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    post: {
        ...
        requestBodySerializer: serializeCreateRule,
