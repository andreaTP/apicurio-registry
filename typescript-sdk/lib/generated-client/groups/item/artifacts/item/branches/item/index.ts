...
// @ts-ignore
import { createBranchMetaDataFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, serializeEditableBranchMetaData, type BranchMetaData, type EditableBranchMetaData, type ProblemDetails } from '../../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const WithBranchItemRequestBuilderUriTemplate = "{+baseurl}/groups/{groupId}/artifacts/{artifactId}/branches/{branchId}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const WithBranchItemRequestBuilderNavigationMetadata: Record<Exclude<keyof WithBranchItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    versions: {
 ...
 */
export const WithBranchItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        uriTemplate: WithBranchItemRequestBuilderUriTemplate,
    ...
    put: {
        ...
        requestBodySerializer: serializeEditableBranchMetaData,
