...
// @ts-ignore
import { createBranchMetaDataFromDiscriminatorValue, createBranchSearchResultsFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, serializeBranchMetaData, serializeCreateBranch, type BranchMetaData, type BranchSearchResults, type CreateBranch, type ProblemDetails } from '../../../../../models/index.js';
// @ts-ignore
import { type WithBranchItemRequestBuilder, WithBranchItemRequestBuilderNavigationMetadata, WithBranchItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
 ...
 */
export const BranchesRequestBuilderUriTemplate = "{+baseurl}/groups/{groupId}/artifacts/{artifactId}/branches{?limit*,offset*}";
/**
...
export const BranchesRequestBuilderNavigationMetadata: Record<Exclude<keyof BranchesRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byBranchId: {
        requestsMetadata: WithBranchItemRequestBuilderRequestsMetadata,
        navigationMetadata: WithBranchItemRequestBuilderNavigationMetadata,
...
export const BranchesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createBranchSearchResultsFromDiscriminatorValue,
    },
    post: {
        uriTemplate: BranchesRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        ...
        adapterMethodName: "send",
        responseBodyFactory:  createBranchMetaDataFromDiscriminatorValue,
        requestBodyContentType: "application/json",
        requestBodySerializer: serializeCreateBranch,
