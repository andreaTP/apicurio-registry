...
import io.apicurio.registry.utils.tests.BasicAuthTestProfile;
...
@QuarkusTest
@TestProfile(BasicAuthTestProfile.class)
@Tag(ApicurioTestTags.SLOW)
public class BasicAuthTest extends AbstractResourceTestBase {
    ...
    protected RegistryClient createRestClientV3() {
        var adapter = new VertXRequestAdapter(buildSimpleAuthWebClient("alice", "alice"));
...
//    }
    ...
    public void testReadOnly() throws Exception {
        var adapter = new VertXRequestAdapter(buildSimpleAuthWebClient("bob", "bob"));
        adapter.setBaseUrl(registryV3ApiUrl);
        RegistryClient client = new RegistryClient(adapter);
