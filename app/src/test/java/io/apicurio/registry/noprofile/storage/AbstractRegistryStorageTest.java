...
public abstract class AbstractRegistryStorageTest extends AbstractResourceTestBase {
    ...
    // ), branches);
    //
    // Assertions.assertEquals(storage().getArtifactBranch(ga, BranchId.LATEST, DEFAULT),
    // storage().getArtifactBranch(ga, otherBranchId, DEFAULT));
    // Assertions.assertEquals(storage().getArtifactBranchTip(ga, BranchId.LATEST, DEFAULT),
    // storage().getArtifactBranchTip(ga, otherBranchId, DEFAULT));
    //
    ...
    // Assertions.assertEquals(List.of(gavV1), storage().getArtifactBranch(ga, BranchId.LATEST,
    // SKIP_DISABLED_LATEST));
    // Assertions.assertEquals(gavV1, storage().getArtifactBranchTip(ga, BranchId.LATEST,
    // ArtifactRetrievalBehavior.SKIP_DISABLED_LATEST));
    //
    // updateVersionState(gavV2.getRawGroupIdWithDefaultString(), gavV2.getRawArtifactId(),
    // gavV2.getRawVersionId(), VersionState.ENABLED);
    // Assertions.assertEquals(List.of(gavV2, gavV1), storage().getArtifactBranch(ga, BranchId.LATEST,
    // SKIP_DISABLED_LATEST));
    // Assertions.assertEquals(gavV2, storage().getArtifactBranchTip(ga, BranchId.LATEST,
    // ArtifactRetrievalBehavior.SKIP_DISABLED_LATEST));
    //
    ...
    //
    // Assertions.assertThrows(ArtifactBranchNotFoundException.class, () -> storage().getArtifactBranch(ga,
    // otherBranchId, DEFAULT));
    // Assertions.assertThrows(VersionNotFoundException.class, () -> storage().getArtifactBranchTip(ga,
    // otherBranchId, DEFAULT));
    //
    // Assertions.assertThrows(NotAllowedException.class, () -> storage().deleteArtifactBranch(ga,
    // BranchId.LATEST));
    // }
    //
