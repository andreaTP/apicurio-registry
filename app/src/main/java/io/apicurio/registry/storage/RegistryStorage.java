...
public interface RegistryStorage extends DynamicConfigStorage {
    ...
    /**
     * Add a version to the artifact branch. The branch is created if it does not exist. The version becomes a
     * new branch tip (latest). Not supported for the "latest" branch.
     */
    void createOrUpdateArtifactBranch(GAV gav, BranchId branchId);

    /**
     * Replace the content of the artifact branch with a new sequence of versions. Not supported for the
     * "latest" branch.
     */
    ...
    /**
     * Delete artifact branch. Not supported for the "latest" branch.
     */
